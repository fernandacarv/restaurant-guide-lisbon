      ...
      <div className="relative flex flex-col text-gray-700 bg-white shadow-md rounded-xl">
        ...
        <div className="p-6 pt-0">
          <Link to={`/restaurants/${restaurant.id}`}>
            <button className="w-full bg-gray-300 px-6 py-3 text-s font-bold uppercase rounded-lg text-blue-gray-900 hover:bg-blue-gray-900/20 focus:bg-blue-gray-900/20 active:bg-blue-gray-900/20 transition duration-300">
              More Information
            </button>
          </Link>
        </div>
